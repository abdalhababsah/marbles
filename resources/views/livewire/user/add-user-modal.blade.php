                ...
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit.prevent="submit"
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder {{ $avatar || $saved_avatar ? '' : 'image-input-empty' }}"
                                ...
                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                    ...
                                    {!! getIcon('pencil','fs-7') !!}
                                    <!--begin::Inputs-->
                                    <input type="file" wire:model.defer="avatar" name="avatar"
                                           accept=".png, .jpg, .jpeg"/>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="password" wire:model.defer="password" name="password" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter password"/>
                            <!--end::Input-->
                            @error('password')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <!--begin::Input group for role (hidden)-->
                        <input type="hidden" wire:model.defer="role" name="role" value="admin"/>
                        <!--end::Input group for role (hidden)-->
